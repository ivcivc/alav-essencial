      ...
      <DialogContent className="max-w-md">
       ...
       <form onSubmit={handleSubmit(handleCreateBlockedDate)} className="space-y-4">
        <div>
         ...
         />
         {errors.blockedDate && (
          <p className="text-sm  mt-1">{errors.blockedDate.message}</p>
         )}
        </div>
        ...
        return (
         <div
          ...
          className={`flex items-start justify-between p-4 rounded-lg border ${
           isPast ? 'bg-card border-border' : 'bg-card border-border'
          }`}
         >
          <div className="flex-1">
           <div className="flex items-center space-x-3 mb-2">
            <div className="flex items-center space-x-2">
             ...
             <span className={`font-medium ${isPast ? 'text-muted-foreground' : 'text-muted-foreground'}`}>
           ...
           {blockedDate.reason && (
            <p className={`text-sm ${isPast ? 'text-muted-foreground' : 'text-muted-foreground'}`}>
