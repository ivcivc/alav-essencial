...
export function ReportsPage() {
  ...
  const appointmentQuery = useAppointmentReport({ ...dateRange, ...filters }, activeTab === 'appointments')
  const financialQuery = useFinancialReport({ ...dateRange, ...filters }, activeTab === 'financial')
  const partnerQuery = usePartnerReport({ ...dateRange, ...filters }, activeTab === 'partners')
  ...
  const handleExport = async (type: 'appointments' | 'financial' | 'partners', format: 'json' | 'csv') => {
    try {
      ...
      if (type === 'appointments') {
        exportFilters = { ...exportFilters, ...filters }
      } else if (type === 'financial') {
        exportFilters = { ...exportFilters, ...filters }
      } else if (type === 'partners') {
        exportFilters = { ...exportFilters, partnerId: filters.partnerId, partnershipType: filters.partnershipType }
      }
