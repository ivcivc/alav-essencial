       ...
       <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-4">
         <div>
          ...
          />
          {errors.totalAmount && (
           <p className="text-sm ">{errors.totalAmount.message}</p>
          )}
         </div>
         ...
         <div>
          ...
          {errors.discountAmount && (
           <p className="text-sm ">{errors.discountAmount.message}</p>
          )}
         </div>
         ...
         <div>
          ...
          {errors.additionalCharges && (
           <p className="text-sm ">{errors.additionalCharges.message}</p>
          )}
         </div>
        </div>
       ...
       <CardContent className="space-y-4">
        <div>
         ...
         {errors.paymentMethod && (
          <p className="text-sm ">{errors.paymentMethod.message}</p>
         )}
        </div>
        ...
        <div>
         ...
         {errors.bankAccountId && (
          <p className="text-sm ">{errors.bankAccountId.message}</p>
         )}
        </div>
