     ...
     <CardContent>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
       {lowStockProducts.map((product) => {
        ...
        return (
         <div key={product.id} className="flex items-center justify-between p-3 bg-card rounded-lg border">
          <div>
           <h4 className="font-medium">{product.name}</h4>
           <p className="text-sm text-muted-foreground">
    ...
    <CardContent>
     {products.length === 0 ? (
      <div className="text-center py-8">
       ...
       <h3 className="mt-2 text-sm font-semibold text-muted-foreground">Nenhum produto encontrado</h3>
