    ...
    <CardContent className="space-y-4">
     ...
     <div className="space-y-2">
      ...
      {errors.defaultChannel && (
       <p className="text-sm ">{errors.defaultChannel.message}</p>
      )}
     </div>
    </CardContent>
   </Card>
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="space-y-2">
       ...
       {errors.firstReminderDays && (
        <p className="text-sm ">{errors.firstReminderDays.message}</p>
       )}
      </div>
      ...
      <div className="space-y-2">
       ...
       {errors.secondReminderDays && (
        <p className="text-sm ">{errors.secondReminderDays.message}</p>
       )}
      </div>
      ...
      <div className="space-y-2">
       ...
       {errors.thirdReminderHours && (
        <p className="text-sm ">{errors.thirdReminderHours.message}</p>
       )}
      </div>
     </div>
    </CardContent>
      ...
      <div className="flex items-center justify-between p-3 border rounded-lg">
       <div className="flex items-center space-x-3">
        ...
        <div>
         ...
         <p className="text-xs text-muted-foreground">Envio via API do WhatsApp</p>
        </div>
       </div>
       <input
        type="checkbox"
      ...
      <div className="flex items-center justify-between p-3 border rounded-lg">
       <div className="flex items-center space-x-3">
        ...
        <div>
         ...
         <p className="text-xs text-muted-foreground">Envio via operadora SMS</p>
        </div>
       </div>
       <input
        type="checkbox"
      ...
      <div className="flex items-center justify-between p-3 border rounded-lg">
       <div className="flex items-center space-x-3">
        ...
        <div>
         ...
         <p className="text-xs text-muted-foreground">Envio via SMTP</p>
        </div>
       </div>
       <input
        type="checkbox"
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="space-y-2">
       ...
       {errors.retryAttempts && (
        <p className="text-sm ">{errors.retryAttempts.message}</p>
       )}
      </div>
      ...
      <div className="space-y-2">
       ...
       {errors.retryIntervalMinutes && (
        <p className="text-sm ">{errors.retryIntervalMinutes.message}</p>
       )}
      </div>
     </div>
    </CardContent>
