    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Visualize todas as notificações enviadas e seus status</p>
        </div>
          ...
          {selectedLog && (
            <div className="space-y-6">
              ...
              {selectedLog.subject && (
                <div>
                  <Label>Assunto:</Label>
                  <p className="bg-gray-50 p-3 rounded border mt-1">
                    {selectedLog.subject}
                  </p>
                </div>
              )}
              ...
              <div>
                ...
                <ScrollArea className="h-32 bg-gray-50 p-3 rounded border mt-1">
              ...
              {selectedLog.errorMessage && (
                <div>
                  ...
                  <p className="bg-red-50 border border-red-200 p-3 rounded mt-1 text-red-700 text-sm">
                    {selectedLog.errorMessage}
                  </p>
                </div>
              )}
              ...
              {selectedLog.providerData && (
                <div>
                  ...
                  <ScrollArea className="h-24 bg-gray-50 p-3 rounded border mt-1">
