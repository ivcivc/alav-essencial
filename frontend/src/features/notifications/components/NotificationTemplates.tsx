    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Gerencie os templates de mensagens para cada canal e tipo de lembrete</p>
        </div>
              ...
              <TabsContent value="variables" className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-medium text-blue-900">Variáveis Disponíveis</span>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {variables.map((variable) => (
                    <Card key={variable.name} className="cursor-pointer hover:bg-gray-50" onClick={() => insertVariable(variable.name)}>
          ...
          {previewTemplate && (
            <div className="space-y-4">
              ...
              {previewTemplate.subject && (
                <div>
                  <Label>Assunto:</Label>
                  <p className="bg-gray-50 p-3 rounded border mt-1 font-mono text-sm">
                    {previewTemplate.subject}
                  </p>
                </div>
              )}
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded border mt-1 whitespace-pre-wrap font-mono text-sm">
