    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Acompanhe estatísticas e status do sistema de notificações</p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-green-600">{statistics?.sent || 0}</p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <p className="text-xs text-red-600">{failureRate.toFixed(1)}%</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">API do WhatsApp Business</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Provedor de SMS (Twilio)</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">SMTP (Nodemailer)</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <p className="text-sm text-green-700">Canais Configurados</p>
                </div>
                <div className="text-center p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">
                    {providers?.available?.length || 0}
                  </div>
                  <p className="text-sm text-blue-700">Canais Disponíveis</p>
                </div>
                <div className="text-center p-4 bg-gray-50 border border-gray-200 rounded-lg">
                  <div className="text-2xl font-bold text-gray-600">
                    {3 - (providers?.configured?.length || 0)}
                  </div>
                  <p className="text-sm text-gray-700">Não Configurados</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-2xl font-bold text-red-600">{failureRate.toFixed(1)}%</span>
                    </div>
                    ...
                    {failureRate > 10 && (
                      <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-red-900">Alta Taxa de Falha</span>
                        </div>
                    ...
                    {(statistics?.pending || 0) > 100 && (
                      <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-yellow-900">Muitas Notificações Pendentes</span>
                        </div>
                    ...
                    {!scheduler?.isRunning && (
                      <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-red-900">Agendador Inativo</span>
                        </div>
                        <p className="text-sm text-red-700 mt-1">
                    ...
                    {failureRate <= 10 && (statistics?.pending || 0) <= 100 && scheduler?.isRunning && (
                      <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium text-green-900">Sistema Funcionando Bem</span>
                        </div>
