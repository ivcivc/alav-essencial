            ...
            <Card className="border-yellow-200 bg-yellow-50">
              <CardContent className="p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-yellow-900">Sistema de Notificações Desabilitado</span>
                </div>
            ...
            <Card className="border-orange-200 bg-orange-50">
              <CardContent className="p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-orange-900">Nenhum Provedor Configurado</span>
                </div>
            ...
            <Card className="border-green-200 bg-green-50">
              <CardContent className="p-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-green-900">Sistema Funcionando Corretamente</span>
                </div>
