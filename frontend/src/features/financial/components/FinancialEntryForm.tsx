...
export function FinancialEntryForm({ 
 ...
 const statusOptions = [
  { value: 'PENDING', label: 'Pendente', className: 'status-badge-warning' },
  { value: 'PAID', label: 'Pago', className: 'status-badge-success' },
  { value: 'OVERDUE', label: 'Vencido', className: 'status-badge-danger' },
  { value: 'CANCELLED', label: 'Cancelado', className: 'status-badge-muted' },
  { value: 'PARTIAL', label: 'Parcial', className: 'status-badge-info' }
 ]
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="space-y-2">
     ...
     {form.formState.errors.bankAccountId && (
      <p className="text-sm ">{form.formState.errors.bankAccountId.message}</p>
     )}
    </div>
   </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="space-y-2">
     ...
     {form.formState.errors.description && (
      <p className="text-sm ">{form.formState.errors.description.message}</p>
     )}
    ...
    <div className="space-y-2">
     ...
     {form.formState.errors.amount && (
      <p className="text-sm ">{form.formState.errors.amount.message}</p>
     )}
    </div>
   </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="space-y-2">
     ...
     {form.formState.errors.category && (
      <p className="text-sm ">{form.formState.errors.category.message}</p>
     )}
    </div>
   ...
   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="space-y-2">
     ...
     {form.formState.errors.dueDate && (
      <p className="text-sm ">{form.formState.errors.dueDate.message}</p>
     )}
    </div>
